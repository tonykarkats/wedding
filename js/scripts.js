$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            ...
            // Event Description
            description: "We can't wait to see you on our big day! For any queries or issues, please contact us on +41788045944."
        }
    });
    ...
    $('#rsvp-wedding-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Just a sec!</strong> We are saving your details.'));
            ...
            $.post('https://script.google.com/macros/s/AKfycbzBa2-WULiZC8e1VKhRBQkzlcAiIVzEqBWcmIm49yx4sR4hou3p38OazHdvKzM7XuGhSw/exec', data)
                .done(function (data) {
                    console.log(data);
